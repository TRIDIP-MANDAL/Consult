...
import { userRoute, protect, optionalUser } from '../middleware/protectRoute.js';

feedback.get('/fetch/:id', getFeedback);
feedback.get('/fetchall', optionalUser, getAllFeedbacks); // here put the user in req object via middleware
